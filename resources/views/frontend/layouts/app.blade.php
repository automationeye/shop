...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ url('public/assets/css/vendors.css') }}">
    @if ($rtl == 1)
        <link rel="stylesheet" href="{{ url('public/assets/css/bootstrap-rtl.min.css') }}">
    @endif
    <link rel="stylesheet" href="{{ url('public/assets/css/aiz-core.css?v=') }}{{ rand(1000, 9999) }}">
...
<body>
    ...
    <script src="{{ url('public/assets/js/aiz-core.js?v=') }}{{ rand(1000, 9999) }}"></script>
    ...
    @if (addon_is_activated('otp_system'))
        <script type="text/javascript">
            ...
            var iti = intlTelInput(input, {
                ...
                utilsScript: "{{ url('public/assets/js/intlTelutils.js') }}?1590403638580",
